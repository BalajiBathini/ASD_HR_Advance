    ...
    def html_to_image(self):
        ...
        if self.chart_type == "list":
            ...
            template_html = self.env["ir.ui.view"]._render_template(
                "asd_cust_dashboard.list_layout", {"recordsets": recordsets}
            )
            ...
            if recordsets.get("layout_type") == "activity":
                ...
                template_html = self.env["ir.ui.view"]._render_template(
                    "asd_cust_dashboard.to_do_layout", {"recordsets": recordsets}
                )
                template_html = f"""<div class="col-sm-12 col-md-12 oe_inner">
                                                                {template_html}
                                                            </div>"""
            ...
            kpi_layout_options = {
                "layout1": "asd_cust_dashboard.kpi_layout_one",
                "layout2": "asd_cust_dashboard.kpi_layout_two",
                "layout3": "asd_cust_dashboard.kpi_layout_three",
                "layout4": "asd_cust_dashboard.kpi_layout_four",
                "layout5": "asd_cust_dashboard.kpi_layout_five",
            }
            tile_layout_options = {
                "layout1": "asd_cust_dashboard.tile_layout_one",
                "layout2": "asd_cust_dashboard.tile_layout_two",
                "layout3": "asd_cust_dashboard.tile_layout_three",
                "layout4": "asd_cust_dashboard.tile_layout_four",
            }
